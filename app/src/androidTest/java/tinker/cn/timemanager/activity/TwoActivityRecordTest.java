...
public class TwoActivityRecordTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void twoActivityRecordTest() {
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.fr_et_activity_name), isDisplayed()));
        editText2.perform(replaceText("ac"), closeSoftKeyboard());
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.fr_et_activity_name), isDisplayed()));
        editText3.perform(replaceText("ac1"), closeSoftKeyboard());
